        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="AdminLTE/AdminLTE-2.4.0-rc/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="AdminLTE/AdminLTE-2.4.0-rc/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
...
<div class="row">
  ...
  <div class="question bgcolor4 " ><b>SINO NGA BA ANG PINAKA LAPUK?<b></div>
...
<div class="row">
  ...
  <label for="muhRadio1"><input type="radio" name="muhRadio" value=""/><span class="font"> SALVO</span></label>
  <br>
  <label for="muhRadio2"><input type="radio" name="muhRadio" value=""/><span class="font"> ZAPLAN</span></label>
  <br>
  <label for="muhRadio3"><input type="radio" name="muhRadio" value=""/><span class="font"> DE SOTTO</span></label>
  <br>
  <label for="muhRadio4"><input type="radio" name="muhRadio" value=""/><span class="font"> PRESBI</span></label>
    <br>

  <button class="btn bgcolor4" style="float:right;height: 50px;"><b>OKAY</b></button>
  </div>
</div>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2018 <a href="#">BS Information and Communication Technology</a>.</strong> All rights reserved.
  </footer>
